...
use Modules\Vehicle\Services\CoreService;
...
class CoresDataTable extends DataTable
{
    ...
    protected function getColumns()
    {
        return [
            ...
            Column::make('vehicle_core_code')->title(__("vehicle::cores.vehicle_core_code")),
            Column::make('vehicle_core_name')->title(__("vehicle::cores.vehicle_core_name")),
            Column::make('vehicle_core_value')->title(__("vehicle::cores.vehicle_core_value")),
