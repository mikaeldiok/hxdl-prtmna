...
class Core extends UserModel implements HasMedia
{
    ...
    protected $table = "vehicle_cores";

    protected static $logName = 'vehicle_cores';
    ...
    public static function getRawData(String $core_code){
        $core_data = self::where('vehicle_core_code', $core_code)->first();
        $raw_data= explode(",",$core_data->vehicle_core_value);
