...
use Modules\Vehicle\DataTables\CoresDataTable;
use Modules\Vehicle\Http\Requests\Backend\CoresRequest;
...
class CoresController extends Controller
{
    ...
    {
        // Page Title
        $this->module_title = trans('menu.vehicle.cores');
        ...
        $this->module_model = "Modules\Vehicle\Entities\Core";
