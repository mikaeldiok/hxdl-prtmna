...
use Modules\Trip\DataTables\DaysDataTable;
use Modules\Trip\Http\Requests\Backend\DaysRequest;
...
class DaysController extends Controller
{
    ...
    public function index_list(Request $request)
    {
        ...
        $$module_name = $this->dayService->getIndexList($request);
    ...
    public function pengawasLogin()
    {
        ...
        return view(
            "trip::backend.$module_name.insert-name",
            compact('module_title', 'module_name', 'module_icon', 'module_action', 'module_name_singular','options')
        );
    }
     ...
     * @return Response
     */
    public function pengawasLoginProccess(Request $request)
    {
        $module_title = $this->module_title;
        $module_name = $this->module_name;
        $module_path = $this->module_path;
    ...
    public function store(DaysRequest $request)
    {
        ...
        $days = $this->dayService->store($request);
    ...
    public function update(DaysRequest $request, $id)
    {
        ...
        $days = $this->dayService->update($request,$id);
    ...
    public function destroy($id)
    {
        ...
        $days = $this->dayService->destroy($id);
    ...
    public function trashed()
    {
        ...
        $days = $this->dayService->trashed();

        $$module_name = $days->data;
    ...
    public function restore($id)
    {
        ...
        $days = $this->dayService->restore($id);
    ...
    public function import(Request $request)
    {
        ...
        $days = $this->dayService->import($request);
    ...
    public function get_day(Request $request)
    {
        ...
        $response = $this->dayService->get_day($request);
